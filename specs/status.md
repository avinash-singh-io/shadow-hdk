...
| 9 — the wire | `phase-9-the-wire` | **in progress** | 4 / 5 groups. D19 state-as-JSON, D20 `Spent`, D21 the crossed context; the ports invert over a loopback; `--stdio` drives a child process; and **`serve` listens** — Phase 5's debt paid. 433 tests; mypy strict over 86 files. Left: the published schemas and v0.1.0 prepared. |
