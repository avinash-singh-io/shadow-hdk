...
| **0010 cross-platform** | **41 (Linux confinement), 42 (the artifact, optional), 43 (Windows, deferred)** | **in progress 2026-09-19**; amended the same day — Linux first, the artifact optional, Windows deferred; opened from `research/2026-09-19-cross-platform-grounding.md`; D122–D137; the OS layer native per OS (A+), the engine's language reviewed under D129 with `research/2026-09-19-the-langgraph-ledger.md`; released per phase |
