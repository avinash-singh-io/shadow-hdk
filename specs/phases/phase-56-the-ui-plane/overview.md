...
type: Phase
status: planned
deps: [phase-54-the-durable-run-request]
---
...
Carries former Phase 38. UI proposes interactions through runtime interfaces and never receives execution authority. Full Shadow desktop/web applications remain lower priority.

## Planning state

Outcome and dependencies only: implementation has not started. Derive this phase's design,
plan, tasks and history at its start from [the roadmap](../../planning/roadmap.md) and the
