...
- Docs: `docs/migrations/0.33.md`, `docs/packages/adapters-environment.md`, `docs/for-a-product.md`'s caveat, the crate's README (the CLI contract); `[ARCH_CHANGE]` for `specs/architecture/adapters.md` synced at completion.
