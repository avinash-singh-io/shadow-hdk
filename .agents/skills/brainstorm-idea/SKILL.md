...
description: "Explore any idea through structured dialogue before committing to anything. Activates when the user invokes /brainstorm-idea or asks momentum to run the brainstorm-idea recipe."
---
