---
name: hotfix
description: "Ship an ad-hoc change without a full phase — a bounded `quick-task` (bugfix / Activates when the user invokes /hotfix or asks momentum to run the hotfix recipe."
---
