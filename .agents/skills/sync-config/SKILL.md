---
name: sync-config
description: "Sync the project's `specs/config.md` with the project's current shape — review drift and apply on approval. Activates when the user invokes /sync-config or asks momentum to run the sync-config recipe."
---
