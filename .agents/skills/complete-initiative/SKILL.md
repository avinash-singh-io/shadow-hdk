...
description: "Verify and close a cross-repo initiative. Activates when the user invokes /complete-initiative or asks momentum to run the complete-initiative recipe."
---
