---
name: sync-docs
description: "Sync all relevant documents based on the active phase's history log. Activates when the user invokes /sync-docs or asks momentum to run the sync-docs recipe."
---
