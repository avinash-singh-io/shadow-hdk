---
name: lanes
description: "Work with lanes — concurrent workstreams in one repo (Rule 15 mechanism). Activates when the user invokes /lanes or asks momentum to run the lanes recipe."
---
