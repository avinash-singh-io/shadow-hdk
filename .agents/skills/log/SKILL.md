---
name: log
description: "Record a manual entry in the active phase history file — or, when no phase is Activates when the user invokes /log or asks momentum to run the log recipe."
---
