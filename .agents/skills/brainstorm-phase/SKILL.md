...
description: "Brainstorm the next phase before creating it. Activates when the user invokes /brainstorm-phase or asks momentum to run the brainstorm-phase recipe."
---
